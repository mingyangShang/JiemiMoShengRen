...
import com.easemod.chat.HXNotifier.HXNotificationInfoProvider;
 ...
 * 
 */
public class SmyHXSDKHelper extends HXSDKHelper {
	...
	protected HXSDKModel createModel() {
		return new SmyHXSDKModel(appContext);
	}
		...
		return new HXNotifier() {
			public synchronized void onNewMsg(final EMMessage message) {
				...
				if (message.getChatType() == ChatType.Chat) {
					...
					notNotifyIds = ((SmyHXSDKModel) hxModel)
							.getDisabledGroups();
				} else {
					chatUsename = message.getTo();
					notNotifyIds = ((SmyHXSDKModel) hxModel).getDisabledIds();
				}
	 ...
	 */
	public SmyHXSDKModel getModel() {
		return (SmyHXSDKModel) hxModel;
	}
